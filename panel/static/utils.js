...
const I18N = {
  "zh": {
      ...
      "title": "HyperScope", "docker-overview": "Docker", "history-title": "历史趋势", "hist-export": "导出", "hist-compare": "对比", "hist-compare-empty": "上一周期暂无数据", "hist-compare-left": "左侧节点", "hist-compare-right": "右侧节点", "hist-compare-need2": "至少需要两个节点", "hist-compare-same": "不能选择同一个节点", "ok": "确定", "sort-default": "默认", "sort-cpu": "CPU", "sort-mem": "内存", "docker-overview": "Docker",
      "docker-title": "Docker", "docker-load": "加载容器中...", "docker-empty": "无容器", "docker-name": "名称", "docker-image": "镜像", "docker-state": "状态", "docker-running": "运行中", "docker-exited": "已停止", "docker-restart": "重启", "docker-logs": "日志", "docker-logs-empty": "无日志", "docker-stop": "停止", "docker-start": "启动", "docker-op-fail": "操作失败", "docker-overview": "Docker", "kline-title": "IO/连接 K线", "kline-read": "读", "kline-write": "写",
  ...
  "en": {
      "theme-auto": "Auto", "docker-empty": "No containers", "docker-exited": "Stopped", "docker-image": "Image", "docker-load": "Loading containers...", "docker-name": "Name", "docker-op-fail": "Operation failed", "docker-overview": "Docker", "docker-restart": "Restart", "docker-logs": "Logs", "docker-logs-empty": "No logs", "docker-running": "Running", "docker-start": "Start", "docker-state": "State", "docker-stop": "Stop", "docker-title": "Docker", "kline-read": "Read", "kline-write": "Write", "kline-title": "IO/Candles", "history-title": "History", "hist-export": "Export", "hist-compare": "Compare", "hist-compare-empty": "No data for previous period", "hist-compare-left": "Left node", "hist-compare-right": "Right node", "hist-compare-need2": "Need at least two nodes", "hist-compare-same": "Cannot pick the same node", "ok": "OK", "sort-default": "Default", "sort-cpu": "CPU", "sort-mem": "Memory", "theme-system": "System", "theme-light": "Light", "theme-dark": "Dark",
      "lang-label": "English",
  ...
  "ru": {
      "theme-auto": "Авто", "docker-empty": "Нет контейнеров", "docker-exited": "Остановлен", "docker-image": "Образ", "docker-load": "Загрузка контейнеров...", "docker-name": "Имя", "docker-op-fail": "Ошибка операции", "docker-overview": "Docker", "docker-restart": "Перезапуск", "docker-logs": "Логи", "docker-logs-empty": "Нет логов", "docker-running": "Запущен", "docker-start": "Старт", "docker-state": "Статус", "docker-stop": "Стоп", "docker-title": "Docker", "kline-read": "Чт", "kline-write": "Зап", "kline-title": "IO/Свечи", "history-title": "История", "hist-export": "Экспорт", "hist-compare": "Сравнить", "hist-compare-empty": "Нет данных за прошлый период", "hist-compare-left": "Левый узел", "hist-compare-right": "Правый узел", "hist-compare-need2": "Нужно минимум два узла", "hist-compare-same": "Нельзя выбрать тот же узел", "ok": "ОК", "sort-default": "По умолчанию", "sort-cpu": "CPU", "sort-mem": "Память", "theme-system": "Как в системе", "theme-light": "Светлая", "theme-dark": "Тёмная",
      "lang-label": "Русский",
...
// Follow OS theme changes live when the panel is in auto/system mode.
window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", () => {
  const mode = getCookie("ts-theme") || "auto";
  if (mode === "auto" || mode === "system") applyTheme(mode);
});
