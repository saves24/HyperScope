...
function showLoginError(msg) {
   ...
   loginErrorTimer = setTimeout(() => el.classList.remove("show"), 5000);
}
...
// probe login state on load (users are created via CLI: hyper-panel user add)
...
const I18N = {
  "zh": {
      ...
      "users-title": "用户管理", "users-add": "添加用户", "users-passwd": "改密", "users-rename": "改名", "users-del": "删除", "users-err-empty": "用户名和密码不能为空", "users-passwd-prompt": "输入新密码", "users-rename-prompt": "输入新用户名", "users-hint": "新用户为普通用户, 仅能查看自己的节点",
      ...
      "op-err": "操作失败",
      "nodes": "节点", "add-node": "添加节点", "add-node-title": "添加节点", "node-list": "节点列表", "node-manage": "节点管理", "node-batch-add": "批量添加", "node-batch-del": "批量删除", "node-batch-hint": "每行一个节点：地址[:端口],key[,名称]", "node-batch-empty": "请输入要添加的节点", "node-batch-result": "批量添加完成：成功 {ok}，失败 {fail}", "node-batch-none": "请先勾选要删除的节点", "node-batch-del-confirm": "确认删除所选节点", "node-import": "本地导入", "node-import-hint": "选择导出的 .hsxc 配置文件并输入导出时的口令", "node-import-pass": "口令", "node-import-nofile": "请先选择 .hsxc 文件", "node-import-pass-need": "请输入口令", "node-import-empty": "配置中没有节点", "node-export": "批量导出", "node-export-hint": "设置一个口令，将当前所有节点加密导出为 .hsxc 文件", "node-export-pass": "口令", "node-export-pass-need": "请设置导出口令", "node-export-empty": "没有可导出的节点", "node-export-ok": "已导出 .hsxc 配置文件", "node-addr-label": "地址", "node-key-label": "API Key",
      ...
      "overview-title": "系统总览", "disks-title": "磁盘总览", "net-title": "网络接口", "trend-title": "实时趋势", "events-title": "事件记录",
      "ov-kernel": "内核", "ov-version": "版本", "ov-load": "负载", "ov-uptime": "运行时间", "ov-procs": "进程数",
      "ev-online": "恢复在线", "ev-offline": "掉线", "ev-unauthorized": "Key 认证失败", "ev-info": "信息", "ev-alert": "告警", "ev-msg-online": "节点恢复在线", "ev-msg-offline": "节点掉线", "ev-msg-unauthorized": "认证失败",
  ...
  "en": {
      ...
      "users-title": "User Management", "users-add": "Add User", "users-passwd": "Password", "users-rename": "Rename", "users-del": "Delete", "users-err-empty": "Username and password required", "users-passwd-prompt": "Enter new password", "users-rename-prompt": "Enter new username", "users-hint": "New users are regular users, only see their own nodes",
      "title": "HyperScope",
      ...
      "ev-online": "back online", "ev-offline": "offline", "ev-unauthorized": "key unauthorized", "ev-info": "info", "ev-alert": "alert", "ev-msg-online": "Node back online", "ev-msg-offline": "Node went offline", "ev-msg-unauthorized": "Authentication failed",
  ...
  "ru": {
      ...
      "users-title": "Управление пользователями", "users-add": "Добавить", "users-passwd": "Пароль", "users-rename": "Переименовать", "users-del": "Удалить", "users-err-empty": "Требуются имя и пароль", "users-passwd-prompt": "Новый пароль", "users-rename-prompt": "Новое имя", "users-hint": "Новые пользователи обычные, видят только свои узлы",
      "title": "HyperScope",
      ...
      "overview-title": "Обзор", "disks-title": "Диски", "net-title": "Сеть", "trend-title": "Графики", "events-title": "События",
      "ov-kernel": "Ядро", "ov-version": "Версия", "ov-load": "Нагрузка", "ov-uptime": "Время работы", "ov-procs": "Процессы",
      "ev-online": "снова в сети", "ev-offline": "офлайн", "ev-unauthorized": "неверный ключ", "ev-info": "инфо", "ev-alert": "оповещение", "ev-msg-online": "Узел снова в сети", "ev-msg-offline": "Узел отключился", "ev-msg-unauthorized": "Ошибка аутентификации",
