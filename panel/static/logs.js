...
function updateEvents() {
  apiFetch("/api/events")
      ...
      .then(d => {
          ...
          const colorMap = { online: "#10b981", offline: "#dc2626", unauthorized: "#f59e0b", info: "#64748b", alert: "#f97316" };
          const labelMap = { online: t("ev-online"), offline: t("ev-offline"), unauthorized: t("ev-unauthorized"), info: t("ev-info"), alert: t("ev-alert") };
