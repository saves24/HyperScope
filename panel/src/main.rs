...
pub(crate) use hyper_panel_core::{
    ...
    node_visible, now_unix, save_nodes, set_retention_days, sha256_hex, ssrf_blocked, tail_log,
    urlencode, valid_user_name, validate_password_only, validate_user_input,
...
mod tests {
    ...
    fn atomic_write_roundtrip() {
        let path = format!("/tmp/hyper-test-{}.json", std::process::id());
    ...
    fn password_hash_and_verify_roundtrip() {
        ...
        let hash = crate::auth::hash_password("secret123");
